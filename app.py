...
def predict():
    ...
    API_KEY = "DB54OUNHMWe4T6m6-kQuXu9XJ1gI6Fq_o-mbVrVW1cSo"
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/ddaca0d4-63d9-46fe-a505-95b101808a5b/predictions?version=2022-06-23', json=payload_scoring,
